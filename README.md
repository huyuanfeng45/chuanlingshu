...
- 任务卡支持按钮操作：刷新状态、截图、打开本机 Codex 线程、重新发送已完成/失败任务、追加队首、清空队列；“刷新状态”只更新任务文字进度，“截图”会单独截取当前 Codex 线程窗口并发送到飞书。
...
任务卡“截图”按钮会打开对应 Codex 线程并截图发回飞书。这个截图能力还需要 macOS 屏幕录制权限：
